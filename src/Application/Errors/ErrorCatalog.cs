...
using static IntegrationImport.Application.Errors.ErrorCodes;
...
public class ErrorCatalog : IErrorCatalog
{
    ...
    public static IErrorCatalog LoadFromFile(string path)
    {
        ...
        if (root.TryGetProperty("IMPORT", out var authArray) && authArray.ValueKind == System.Text.Json.JsonValueKind.Array)
        {
    ...
    public ErrorInfo GetError(string code)
    {
        ...
        const string Fallback = IMPORT.AnImportErrorOccurredInJson;
